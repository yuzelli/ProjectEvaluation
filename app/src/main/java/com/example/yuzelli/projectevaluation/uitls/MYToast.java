...
import com.example.yuzelli.projectevaluation.app.MyAppliction;
...
public class MYToast extends Toast {
	...
	public static void show(String content) {
		...
		mToast =  MYToast.makeText(MyAppliction.getContextObject(), 0, content, 100);
		mToast.show();
	}
	public static void show(String content, int drawableID) {
		
		mToast =  MYToast.makeText(MyAppliction.getContextObject(),drawableID, content, 100);
		mToast.show();
	}
